...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void StationDistance(IDal iDal)
        {
            Console.WriteLine("\nENTER longitude");
        ...
        /// </summary>
        /// <param name="dalObject"></param>
        public static void CustomerDistance(IDal iDal)
        {
            Console.WriteLine("\nENTER longitude");
            double.TryParse(Console.ReadLine(), out double longitude);
            Console.WriteLine("\nENTER lattitude");
        ...
        /// add a station
        /// </summary>
        public static void AddStation(IDal iDal)
        {
            Station station = new();
        ...
        /// add a drone
        /// </summary>
        public static void AddDrone(IDal iDal)
        {
            Drone drone = new();
        ...
        /// adds a customer
        /// </summary>
        public static void AddCustomer(IDal iDal)
        {
        ...
        /// adds a parcel
        /// </summary>
        public static void AddParcel(IDal iDal)
        {
            Parcel parcel = new();
            Console.WriteLine("\nENTER sender ID");
        ...
        /// </summary>
        public static void SetParcelToDrone(IDal iDal)
        {
            Console.WriteLine("\nENTER parcel ID");
        ...
        /// </summary>
        public static void ParcelPickup(IDal dalObject)
        {
            Console.WriteLine("\nEnter ID of parcel");
            _ = int.TryParse(Console.ReadLine(), out int parcelId);
        ...
        /// </summary>
        public static void ParcelDelivered(IDal dalObject)
        {
            Console.WriteLine("\nEnter id of parcel");
            _ = int.TryParse(Console.ReadLine(), out int parcelId);
        ...
        /// </summary>
        private static void FinishCharge(IDal dalObject)
        {
            Console.WriteLine("\nENTER id of drone");
            _ = int.TryParse(Console.ReadLine(), out int droneId);
        ...
        /// display parcel
        /// </summary>
        public static void ParcelDisplay(IDal dalObject)
        {
        ...
        /// </summary>
        public static void DroneCharge(IDal dalObject)
        {
            Console.WriteLine("\nENTER id of drone");
            _ = int.TryParse(Console.ReadLine(), out int droneId);
        ...
        /// display customer
        /// </summary>
        public static void CustomerDisplay(IDal dalObject)
        {
        ...
        /// dispay drone
        /// </summary>
        public static void DroneDisplay(IDal Dal)
        {
        ...
        /// display station
        /// </summary>
        public static void StationDisplay(IDal iDal)
        {
            try
            {
        ...
        /// </summary>
        public static void StationListDisplay(IDal iDal)
        {
        ...
        /// </summary>
        public static void DroneListDisplay(IDal iDal)
        {
        ...
        /// </summary>
        public static void CustomerListDisplay(IDal iDal)
        {
        ...
        /// </summary>
        public static void ParcelListDisplay(IDal iDal)
        {
        ...
        /// </summary>
        public static void StationsWithFreeSlotsDisplay(IDal iDal)
        {
        ...
        /// </summary>
        public static void UnassosiatedParcelListDisplay(IDal iDal)
        {
            foreach (var Parcel in iDal.ParcelList())
                if (Parcel.DroneId != 0)
                    Console.WriteLine(Parcel.ToString());
